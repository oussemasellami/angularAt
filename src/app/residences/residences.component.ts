...
export class ResidencesComponent {
  ...
  afficheappartement(residence:number){
...
this.selectedAppa=applist
  }

  buy(apppart:Appartement){
let i=this.appartementsList.indexOf(apppart)
